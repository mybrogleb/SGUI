# SIMPLE GUI для SFML
Этот репозиторий разработывается для упрощения работы с SFML. Основная идея: простота и гибкость. 
Синтаксис похож на FLTK. Проект представляет из себя файлы .hpp и ресурсы для быстрого старта.
...
# ОБРАТНАЯ СВЯЗЬ
**Если нашли ошибку или есть идеи сообщите через issue**
...
- [Важно](https://github.com/mybrogleb/SGUI/blob/master/README.md#%D0%B2%D0%B0%D0%B6%D0%BD%D0%BE)
...
```
А что если надо передать данные в функцию? Решение: лямбда-функция
...
### Label [src/Label.hpp](src/Label.hpp)
...
> Вообще, можно ещё быстрее, если у вас уже есть проект с SFML
> > Просто копируйте все .h туда где ваш main и шрифт в папку где ваш проект Visual Studio
> > > Перед main добавьте include "SGUI.hpp"

# ВАЖНО
- на данный момент нет пространства имен!
